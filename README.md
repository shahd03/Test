...
Helm Charts - Application packaging documentation

Terraform Configuration - Infrastructure as code documentation

Ansible Playbooks - Automation and configuration management
